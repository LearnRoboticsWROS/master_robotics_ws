...
void process_pcl_data(const std::string& input_pcd, const std::string& output_pcd)
{
    ...
    voxel_filter.setLeafSize(0.0001, 0.0001, 0.0001); // PLAY
    ...
    neg_plane_extracted.setNegative(true);
    ...
    // Get the inliers and the coefficient
    ...
    // compute the centroid of the extraced cylinder points
